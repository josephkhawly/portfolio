...
function ProjectCard({ image, name }: { image: string, name: string }) {
    return (
        <div className="border mockup-window bg-base-300 lg:h-72 hover:bg-[#0025FF] cursor-pointer transition-colors">
...
function MobileProjectCard({ image, name }: { image: string, name: string }) {
    return (
        <div className="mockup-phone md:w-auto">
