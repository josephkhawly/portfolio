                ...
                <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
                    <div className="space-y-12">
                        <div>
                            ...
                            <input className="w-full border px-4 py-4" />
                        </div>
                        <div>
                            <label className="text-white block mb-6 text-xl font-bold">Email</label>
                            <input type="email" className="w-full border px-4 py-4" />
                        </div>
                        <div>
                            <label className="text-white block mb-6 text-xl font-bold">Message</label>
                            <textarea className="w-full border px-4 py-4 h-56 resize-none"></textarea>
                        </div>
                        <button className="px-6 py-2 text-white font-bold">Send it!</button>
                    </div>

                    <div className="mt-12">
                        {/* <!-- Contact info --> */}
                        <a href="mailto:email@mydomain.com" className="underline mt-3 block">email@mydomain.com</a>
