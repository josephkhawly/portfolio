            ...
            <div className="flex flex-wrap md:flex-nowrap">
                <div className="flex flex-wrap lg:ml-20 justify-center md:justify-start max-w-xl mt-0 md:my-36">
                    ...
                    <div className="w-full flex justify-center md:justify-start">
                        <button className="px-8 py-4 text-white font-bold mt-12 flex items-center space-x-3">
                            <div>
                ...
                <img src="/images/man.png" alt="Man" className="w-3/4 md:absolute -mt-6 md:mt-0 right-0 -z-1" />
            </div>
        </div>
    )
}