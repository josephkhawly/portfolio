function ClientItem() {
    return (
        <div className="w-full border p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap">
            ...
            <div className="flex flex-wrap justify-center text-center lg:text-left lg:block">
                ...
                <p className="">I’ve had the pleasure of working with multiple Fortune 500 companies, designing and implementing both frontend and backend.</p>
            </div>
